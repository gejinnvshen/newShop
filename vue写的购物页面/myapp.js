    ...
    methods:{
        ...
        */
        addItem:function(index){
                ...
                Vue.set(this.lists[index],'totalPrice',this.lists[index].price*this.lists[index].count);
                console.log(Vue.set(this.lists[index],'count',1));  //1  返回设置的值
        ...
        */
        increaseGoods:function(index){
            this.purchase[index].count++;
            console.log(this.purchase[index].count)
            this.calPrice(index);
        },
        decreGoods:function(index){
            this.purchase[index].count--;
            this.calPrice(index);
console.log(tab.selectAll)

        },
        /*封装计算价格*/
        calPrice:function(index){
            Vue.set(this.purchase[index],'subtotal',this.purchase[index].price*this.purchase[index].count);
            Vue.set(this.purchase[index],'totalPrice',this.purchase[index].price*this.purchase[index].count);
        }
    },
    computed:{
        ...
        */
        selectAll:function(){
            ...
            this.purchase.forEach(function(item){
